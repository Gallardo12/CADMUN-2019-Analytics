...
<script>\$(document).ready(function () { require('{{ jsNamespace }}').{{ jsClass }}.initElements(); });</script>", "@CoreHome\\_uiControl.twig", "/home/revdevel/analytics.cadmun.net/plugins/CoreHome/templates/_uiControl.twig");
    }
}
